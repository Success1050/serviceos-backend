...
const maintenance_cron_1 = require("./maintenance.cron");
...
exports.MaintenanceModule = MaintenanceModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [maintenance_service_1.MaintenanceService, maintenance_processor_1.MaintenanceProcessor, maintenance_cron_1.MaintenanceCronService],
    })
], MaintenanceModule);
